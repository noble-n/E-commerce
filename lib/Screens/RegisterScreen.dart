          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                AuthenticationTextFormGlobal(controller: firstnameController, text: "Enter firstName", textInputType: TextInputType.text, obscure: false),
                const SizedBox(height: 20,),
                AuthenticationTextFormGlobal(controller: lastnameController, text: "Enter lastName", textInputType: TextInputType.text, obscure: false),
                const SizedBox(height: 20,),
                ...
                const SizedBox(height: 20,),
                AuthenticationTextFormGlobal(controller: confirmPasswordController, text: "Confirm password", textInputType: TextInputType.visiblePassword, obscure: true,suffixIcon: Icons.visibility_off,),
